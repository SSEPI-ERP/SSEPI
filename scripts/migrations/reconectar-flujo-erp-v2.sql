-- =====================================================
-- RECONEXIÓN DE FLUJO ERP - V2 (usa estructura existente)
-- Basado en tablas reales de la BD
-- =====================================================
...
-- ================================================
-- 2. TABLA reservas_material (si no existe)
-- ================================================
...
-- ================================================
-- 3. TABLA ordenes_costos (FALTA - crear)
-- ================================================
...
BEGIN
    ...
    -- Registrar movimiento (usando estructura existente)
