-- ============================================================================
-- MIGRACIÓN: Actualizar políticas_modulos con textos completos de los 5 módulos
-- FIX: usa to_jsonb(ARRAY[...]) porque notas_importantes es jsonb
-- Ejecutar en Supabase SQL Editor
-- ============================================================================

-- 1) Taller Electrónica (8 notas)
...
-- 3) Ventas y Suministros (14 notas)
INSERT INTO public.politicas_modulos (modulo, titulo, tiempo_entrega, garantia_dias, moneda, url_terminos, notas_importantes, activo, updated_at)
VALUES (
  'ventas_suministros',
