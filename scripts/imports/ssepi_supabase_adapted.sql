-- ADAPTADO SSEPI: tablas y datos en schema ssepi_import
...
CREATE INDEX IF NOT EXISTS idx_bom_materiales_nombre_del_proveedor ON bom_materiales(nombre_del_proveedor);
CREATE INDEX IF NOT EXISTS idx_bom_materiales_nombre_del_proveedor_2 ON bom_materiales(nombre_del_proveedor_2);
CREATE INDEX IF NOT EXISTS idx_bom_materiales_nombre_del_proveedor_3 ON bom_materiales(nombre_del_proveedor_3);
CREATE INDEX IF NOT EXISTS idx_bom_materiales_nombre_del_proveedor_4 ON bom_materiales(nombre_del_proveedor_4);

-- ── bom_datos_referencia (Fuente: BOM_SSEPI / Datos) ──
CREATE TABLE IF NOT EXISTS bom_datos_referencia (
  id BIGSERIAL PRIMARY KEY,
  actualizado TEXT,
  sensores TEXT,
  created_at TIMESTAMPTZ DEFAULT NOW()
);
ALTER TABLE bom_datos_referencia ENABLE ROW LEVEL SECURITY;
...
CREATE INDEX IF NOT EXISTS idx_contactos_nombre_completo ON contactos(nombre_completo);

-- ── cotizacion_viajes (Fuente: FORMULAS_DE_COTIZACIÓN / Hoja1) ──
CREATE TABLE IF NOT EXISTS cotizacion_viajes (
  id BIGSERIAL PRIMARY KEY,
  empresa TEXT,
  km_x2 NUMERIC(15,4),
  litros NUMERIC(15,4),
...
ALTER TABLE cotizacion_viajes ENABLE ROW LEVEL SECURITY;

-- ── cotizacion_laboratorio (Fuente: FORMULAS_DE_COTIZACIÓN / LABORATORIO) ──
CREATE TABLE IF NOT EXISTS cotizacion_laboratorio (
  id BIGSERIAL PRIMARY KEY,
  col_30 TEXT,
  col_87 TEXT,
  col_80 TEXT,
...
ALTER TABLE cotizacion_laboratorio ENABLE ROW LEVEL SECURITY;

-- ── cotizacion_motores (Fuente: FORMULAS_DE_COTIZACIÓN / MOTORES) ──
CREATE TABLE IF NOT EXISTS cotizacion_motores (
  id BIGSERIAL PRIMARY KEY,
  col_30 TEXT,
  col_87 TEXT,
  col_52_67 TEXT,
...
ALTER TABLE cotizacion_motores ENABLE ROW LEVEL SECURITY;

-- ── cotizacion_automatizacion (Fuente: FORMULAS_DE_COTIZACIÓN / AUTOMATIZACIÓN) ──
CREATE TABLE IF NOT EXISTS cotizacion_automatizacion (
  id BIGSERIAL PRIMARY KEY,
  col_650 TEXT,
  col_700 TEXT,
  col_450 TEXT,
...
ALTER TABLE cotizacion_automatizacion ENABLE ROW LEVEL SECURITY;

-- ── cotizacion_suministros (Fuente: FORMULAS_DE_COTIZACIÓN / SUMINISTROS) ──
CREATE TABLE IF NOT EXISTS cotizacion_suministros (
  id BIGSERIAL PRIMARY KEY,
  col_30 TEXT,
  col_87 TEXT,
  col_52_67 TEXT,
...
ALTER TABLE cotizacion_suministros ENABLE ROW LEVEL SECURITY;

-- ── inventario_automatizacion (Fuente: Inventario_Automatizacion / Stock) ──
CREATE TABLE IF NOT EXISTS inventario_automatizacion (
  id BIGSERIAL PRIMARY KEY,
  fecha TIMESTAMPTZ,
  cantidad INTEGER,
  categoria TEXT,
...
ALTER TABLE inventario_automatizacion ENABLE ROW LEVEL SECURITY;
CREATE INDEX IF NOT EXISTS idx_inventario_automatizacion_fecha ON inventario_automatizacion(fecha);
CREATE INDEX IF NOT EXISTS idx_inventario_automatizacion_categoria ON inventario_automatizacion(categoria);
CREATE INDEX IF NOT EXISTS idx_inventario_automatizacion_num_parte ON inventario_automatizacion(num_parte);
CREATE INDEX IF NOT EXISTS idx_inventario_automatizacion_fecha_de_salida ON inventario_automatizacion(fecha_de_salida);

-- ── inventario_electronica (Fuente: inventario_electronica_ssepi / Sheet1) ──
CREATE TABLE IF NOT EXISTS inventario_electronica (
  id BIGSERIAL PRIMARY KEY,
  codigo_marking TEXT,
  descripcion TEXT,
  existencia INTEGER,
...
ALTER TABLE inventario_electronica ENABLE ROW LEVEL SECURITY;
CREATE INDEX IF NOT EXISTS idx_inventario_electronica_codigo_marking ON inventario_electronica(codigo_marking);
...
CREATE INDEX IF NOT EXISTS idx_ordenes_compra_referencia_de_la_orden ON ordenes_compra(referencia_de_la_orden);
CREATE INDEX IF NOT EXISTS idx_ordenes_compra_proveedor ON ordenes_compra(proveedor);
CREATE INDEX IF NOT EXISTS idx_ordenes_compra_fecha_limite_de_la_orden ON ordenes_compra(fecha_limite_de_la_orden);
...
CREATE INDEX IF NOT EXISTS idx_ordenes_reparacion_referencia_de_reparacion ON ordenes_reparacion(referencia_de_reparacion);
CREATE INDEX IF NOT EXISTS idx_ordenes_reparacion_fecha_programada ON ordenes_reparacion(fecha_programada);
CREATE INDEX IF NOT EXISTS idx_ordenes_reparacion_estado_del_componente ON ordenes_reparacion(estado_del_componente);
CREATE INDEX IF NOT EXISTS idx_ordenes_reparacion_cliente ON ordenes_reparacion(cliente);
...
CREATE INDEX IF NOT EXISTS idx_ordenes_venta_referencia_de_la_orden ON ordenes_venta(referencia_de_la_orden);
CREATE INDEX IF NOT EXISTS idx_ordenes_venta_fecha_de_creacion ON ordenes_venta(fecha_de_creacion);
CREATE INDEX IF NOT EXISTS idx_ordenes_venta_cliente ON ordenes_venta(cliente);
...
INSERT INTO bom_datos_referencia (actualizado, sensores)
VALUES
...
-- ── Datos: contactos ──
INSERT INTO contactos (avatar_128, nombre_completo, correo_electronico, telefono, actividades, pais, estadisticas)
VALUES
...
INSERT INTO cotizacion_viajes (empresa, km_x2, litros, gasolina, gasolina2, hrs, hr_dani, dani, total)
VALUES
...
INSERT INTO cotizacion_laboratorio (col_30, col_87, col_80, col_161_85, col_52_67)
VALUES
...
INSERT INTO cotizacion_motores (col_30, col_87, col_52_67)
VALUES
...
INSERT INTO cotizacion_automatizacion (col_650, col_700, col_450, col_900, col_350, col_600, col_1100, col_150, col_52_67, col_30, col_161_85)
VALUES
...
INSERT INTO cotizacion_suministros (col_30, col_87, col_52_67)
VALUES
  ('GASOLINA', 'VENTAS', 'CAMIONETA X HORA'),
  ('600', '435', '263.35'),
  ('600', '435', '263.35'),
...
INSERT INTO inventario_automatizacion (fecha, cantidad, categoria, num_parte, descripcion, costo_unitario, importe, entradas, salidas, fecha_de_salida)
VALUES
...
INSERT INTO inventario_electronica (codigo_marking, descripcion, existencia, ubicacion, encapsulado, link_octopart, link_digikey, link_mouser, costo_unitario_mxn, total_linea_mxn)
VALUES
...
INSERT INTO ordenes_compra (prioridad, referencia_de_la_orden, proveedor, comprador, fecha_limite_de_la_orden, actividades, total, estado)
VALUES
...
INSERT INTO ordenes_reparacion (prioridad, referencia_de_reparacion, fecha_programada, producto_a_reparar, estado_del_componente, cliente, orden_de_venta, estado, decoracion_de_la_actividad_de_excepcion)
VALUES
...
-- ── Datos: ordenes_venta ──
INSERT INTO ordenes_venta (referencia_de_la_orden, fecha_de_creacion, cliente, vendedor, actividades, total, estado)
VALUES
